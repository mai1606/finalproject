            ...
            if let document = document, document.exists {
               ...
               let  isPeriodDb = document.data()!["periods"] as! [String]
                ...
                if self.isPeriod.contains(aDay){
                  ...
                  // print("อะไรกันนี้",self.daycalculate)
                }
